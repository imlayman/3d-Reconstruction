...
'''
    ...
    # neighbor_x,neighbor_feat:(B,C,N,k)
...
class PnP3D(nn.Module):
    ...
    def forward(self, xyz, features, k):
        ...
        # print('xyz',neighbor_xyz.size())
        # print('feat',neighbor_feat.size())
        ...
        f_encoding = f_encoding.max(dim=-1, keepdim=False)[0] # B,C,N max pooling
